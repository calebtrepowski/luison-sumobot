...
#define ATTACK_FRONT_FULL_GAS_SPEED 4U
#define ATTACK_FRONT_LIFT_OFF_SPEED 3U

#define AIM_FRONT_SIDE_MAX_TURN_DURATION 50U // ms
#define AIM_FRONT_SIDE_TURN_ANGLE 2 * 45     // ° (degrees)

#define AIM_FRONT_SIDE_SPEED_OUTER 4U
...
#define AVOID_FALL_FRONT_REVERSE_DURATION 150U  // ms
#define AVOID_FALL_FRONT_MAX_TURN_DURATION 250U // ms
#define AVOID_FALL_FRONT_TURN_ANGLE 2 * 30      // ° (degrees)
#define AVOID_FALL_FRONT_REVERSE_SPEED 3U
#define AVOID_FALL_FRONT_TURN_SPEED 3U

#define AIM_BACK_MAX_TURN_DURATION 300U // ms
#define AIM_BACK_TURN_ANGLE 2 * 180     // ° (degrees)
#define AIM_BACK_SPEED_OUTER 4U
#define AIM_BACK_SPEED_INNER 2U

#define DIAGONAL_KICKBACK_MAX_REVERSE_TIME 300U // ms
#define DIAGONAL_KICKBACK_INNER_REVERSE_SPEED 2U
#define DIAGONAL_KICKBACK_OUTER_REVERSE_SPEED 4U
