...
#define AVOID_FALL_FRONT_REVERSE_SPEED 4U
#define AVOID_FALL_FRONT_TURN_SPEED 4U

#define AIM_BACK_MAX_TURN_DURATION 300U // ms
#define AIM_BACK_TURN_ANGLE 2 * 180     // ° (degrees)
#define AIM_BACK_SPEED_OUTER 6U
#define AIM_BACK_SPEED_INNER 3U

#define DIAGONAL_KICKBACK_MAX_REVERSE_TIME 300U // ms
#define DIAGONAL_KICKBACK_INNER_REVERSE_SPEED 3U
#define DIAGONAL_KICKBACK_OUTER_REVERSE_SPEED 5U
